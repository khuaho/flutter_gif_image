...
import 'package:flutter_gif_image/src/gif_cache.dart';
import 'package:flutter_gif_image/src/gif_controller.dart';
import 'package:flutter_gif_image/src/gif_frame.dart';
import 'package:http/http.dart' as http;

export 'package:flutter_gif_image/src/gif_controller.dart';
export 'package:flutter_gif_image/src/gif_helper.dart';

final Map<String, List<GifFrame>> _cache = {};

class FlutterGifView extends StatefulWidget {
...
class GifViewState extends State<FlutterGifView> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant FlutterGifView oldWidget) {
